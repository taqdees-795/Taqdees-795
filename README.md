# 👩‍💻 Taqdees Arshad – AI & .NET Developer
...
### 1️⃣ **AI Career Detector**
- **Description:** Suggests AI career paths based on skills & interests  
- **Technologies:** C#, Windows Forms, ML.NET  
...
```bash
git clone https://github.com/taqdees-795/AI_Career_Detector.git
